import { Authenticated, AuthPage, ErrorComponent, Refine, type ResourceProps } from "@refinedev/core";
  ...
  <BrowserRouter>
    ...
    >
      <Routes>
        ...
        <Route path={template(r.register)} element={<AuthPage type="register" />} />
        <Route path={template(r.login)} element={<AuthPage type="login" />} />
        <Route path={template(r.forgotPassword)} element={<AuthPage type="forgotPassword" />} />
        <Route path={template(r.updatePassword)} element={<AuthPage type="updatePassword" />} />
