...
type ProductFormValues = Required<
  Pick<ProductRecord, "name" | "description" | "category" | "price">
>;
...
export const useProductForm = () => {
  ...
  const {
    ...
    validate: {
      name: isNotEmpty(
        t("pages.product.productForm.nameEmpty", "This field is required"),
      ),
      description: isNotEmpty(
        t(
          "pages.product.productForm.descriptionEmpty",
          "This field is required",
        ),
      ),
      category: isNotEmpty(
        t("pages.product.productForm.categoryEmpty", "This field is required"),
      ),
    },
  });
  ...
  return (
    <>
      <TextInput
        ...
        placeholder={t(
          "pages.product.productForm.namePlaceholder",
          "Please enter a name",
        )}
      ...
      <Textarea
        ...
        placeholder={t(
          "pages.product.productForm.descriptionPlaceholder",
      ...
      <NumberInput
        ...
        placeholder={t(
          "pages.product.productForm.pricePlaceholder",
      ...
      <Select
        ...
        placeholder={t(
          "pages.product.productForm.categoryPlaceholder",
